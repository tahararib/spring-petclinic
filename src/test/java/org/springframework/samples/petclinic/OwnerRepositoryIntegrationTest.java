...
/**
 * Tests d'intégration sur la base PostgreSQL réelle via Testcontainers.
 * Vérifie que Flyway a bien appliqué les migrations V1, V2, V3.
 * Formation DevOps ? Lab 07.
 */
class OwnerRepositoryIntegrationTest extends PostgresIntegrationTest {
    ...
    void table_pets_doit_avoir_colonne_weight_apres_migration_V3() {
        Integer count = jdbcTemplate.queryForObject(
            ...
            "WHERE table_name = 'pets' AND column_name = 'weight'",
            Integer.class);
    ...
    void table_owners_doit_avoir_index_telephone_apres_migration_V2() {
        Integer count = jdbcTemplate.queryForObject(
            ...
            "WHERE tablename = 'owners' AND indexname = 'owners_telephone_idx'",
            Integer.class);
        assertThat(count).isEqualTo(1);
    }
